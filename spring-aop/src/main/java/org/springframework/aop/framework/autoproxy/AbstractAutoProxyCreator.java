...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		//实例化的同时，继承了父类，父类的构造函数中 this.aopProxyFactory = new DefaultAopProxyFactory();
	...
	private Advisor[] resolveInterceptorNames() {
		...
		//判断this.interceptorNames参数中是否有值，若是有的话，则实例化，然后判断他是否继承MethodInterceptor，
		//若是继承了则实例化一个默认的advisor ：DefaultPointcutAdvisor ，这个advisor pointcut设置为true，表示全都拦截
